...
- **Selected**: **Native `window.fetch` with 3x Cold-Start Auto-Retry** in [`api.js`](file:///c:/Users/Admin/Desktop/client/src/services/api.js)
...
- **Why Vercel was Selected**:
  ...
  - Clean rewrite rules via [`vercel.json`](file:///c:/Users/Admin/Desktop/client/vercel.json) ensuring zero 404s on deep React Router paths (`/documents/:id`, `/settings`).
