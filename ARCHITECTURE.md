...
- **Client Resilience**: Custom `fetch` interceptor in [`api.js`](file:///c:/Users/Admin/Desktop/client/src/services/api.js) that intercepts `502`, `503`, and network dropouts during PaaS cold-starts, automatically waiting 2 seconds and retrying up to 3 times before raising UI errors.
...
- **Client Auto-Retry**: If a network hiccup or cold-start does occur, the React client's [`api.js`](file:///c:/Users/Admin/Desktop/client/src/services/api.js) automatically pauses and retries up to 3 times before displaying any error to the user.
